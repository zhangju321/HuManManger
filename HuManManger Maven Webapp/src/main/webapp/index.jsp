...
<body>
	<div id="wrap">
		...
		<div class="leftMeun" id="leftMeun">
			<div id="logoDiv">
				<p id="logoP">
					<img id="logo" alt="人力资源管理系统" src="images/logo.png"><span>人力资源管理系统</span>
				</p>
			</div>
			<div id="personInfor">
				<p id="userName">张钜</p>
			...
			<div class="meun-title">招聘计划</div>
			<div class="meun-item" href="/HuManManger/wmw/select_plan.jsp" aria-controls="scho" role="tab"
				data-toggle="tab">
				<img src="/HuManManger/wmw/select_plan.jsp">新建招聘计划
			</div>
			<div class="meun-item" href="/HuManManger/wmw/up_plan.jsp" aria-controls="regu" role="tab"
				data-toggle="tab">
				<img src="/HuManManger/wmw/up_plan.jsp">审批招聘计划
			</div>
			<div class="meun-item" href="#stud" aria-controls="stud" role="tab"
				data-toggle="tab">
				<img src="images/icon_card_grey.png">薪酬管理
			</div>
		...
		<label for="lastname" class="col-sm-2 control-label">项目类型</label>
			<div class="col-sm-3">
		    <select name="project_type" style="	background-color: #f9f9f9; min-width: 160px; padding: 2px 9px;"> <option>项目类型</option>
			<option vaule="project_type">考勤扣款标准设置</option>
			<option vaule="project_type">薪资基数设置</option>
			<option vaule="project_type">福利管理设置</option></select>
			</div> 
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-7">
				<input type="button" class="btn btn-default" onclick="save()"
					value="添加">
			</div>
		</div>
	</form>
		...
		$.ajax({
			...
			success : function(data) {
				...
				for (var i = 0; i < data.length; i++) {
					...
					tr += "<td><input type='button' id='" + obj.project_id + "' value='修改' class='update'><input type='button' id='" + obj.project_id + "' value='删除' class='delete'></td>";
