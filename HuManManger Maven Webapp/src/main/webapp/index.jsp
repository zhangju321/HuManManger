	...
	<div class="row clearfix">
		<div class="col-md-2 column">
			<div class="panel-group" id="panel-159773">
				<div class="panel panel-default">
					<div class="panel-heading">
						 <a class="panel-title" data-toggle="collapse" data-parent="#panel-159773" href="#panel-element-467705">薪资管理</a>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						 <a class="panel-title" data-toggle="collapse" data-parent="#panel-159773" href="#panel-element-786865">招聘管理</a>
					</div>
			...
			<div class="panel-group" id="panel-721071">
				<div class="panel panel-default">
					<div class="panel-heading">
						 <a class="panel-title" data-toggle="collapse" data-parent="#panel-721071" href="#panel-element-342761">人员管理</a>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						 <a class="panel-title" data-toggle="collapse" data-parent="#panel-721071" href="#panel-element-968625">考勤管理</a>
					</div>
					<div id="panel-element-968625" class="panel-collapse collapse">
						<div class="panel-body">
							<a href="config.jsp" target="main">考勤设置</a>
						</div>
						<div class="panel-body" >
